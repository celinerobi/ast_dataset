...
def main(args):
    ...
    fc.write_list(state_year_img_paths, os.path.join(args.params_directory,"state_year_img_paths.json"))
    fc.write_list(state_year_xml_paths, os.path.join(args.params_directory,"state_year_xml_paths.json"))
    ##six digit idx
    state_year_six_digit_idx_list = fc.get_six_digit_index_from_img_path(state_year_img_paths)
    fc.write_list(state_year_six_digit_idx_list, os.path.join(args.params_directory,"state_year_six_digit_idx_list.json"))
    #standard quad
    ...
    fc.write_list(standard_img_paths, os.path.join(args.params_directory,"standard_img_paths.json"))
    fc.write_list(standard_xml_paths, os.path.join(args.params_directory,"standard_xml_paths.json"))
    #yx indx
    ys, xs = fc.get_x_y_index(standard_img_paths)
    yx_list = np.vstack((ys, xs)).T
    np.save(os.path.join(args.params_directory,"yx_list.npy"), yx_list)
