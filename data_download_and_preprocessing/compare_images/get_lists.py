...
def main(args):
    ...
    fc.write_list(state_year_img_paths, os.path.join(args.directory,"state_year_img_paths.json"))
    fc.write_list(state_year_xml_paths, os.path.join(args.directory,"state_year_xml_paths.json"))

    six_digit_index_list = fc.get_six_digit_index_from_img_path(state_year_img_paths)
    fc.write_list(six_digit_index_list, os.path.join(args.directory,"six_digit_idxs.json"))
