...
Example:
python seperate_positive_negative_images.py  --annotation_directory unverified_images_not_reviewed_by_student2_Desbans --parent_directory \\oit-nas-fe13dc.oit.duke.edu\\data_commons-borsuk\\labelwork
